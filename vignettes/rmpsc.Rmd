...
A prerequisite for the rmspc package is .NET 8.0 (since it is developed
...
of the installed framework (should be 8.0 or newer). If not installed,
you may install following 
[these instructions](https://dotnet.microsoft.com/en-us/download/dotnet/8.0).
